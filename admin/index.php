 ...
 * @version   CVS: $Id: index.php,v 1.11 2007/12/01 11:59:47 jact Exp $
 ...
 */
  ...
  HTML::section(1, $title, array('class' => 'icon icon_admin'));
  ...
  HTML::section(2, HTML::strLink(_("Config settings"), '../admin/setting_edit_form.php'),
  ...
  HTML::section(2, HTML::strLink(_("Staff Members"), '../admin/staff_list.php'), array('class' => 'icon icon_staff'));
  ...
  HTML::section(2, HTML::strLink(_("Users"), '../admin/user_list.php'), array('class' => 'icon icon_user'));
  ...
  HTML::section(2, HTML::strLink(_("Themes"), '../admin/theme_list.php'), array('class' => 'icon icon_theme'));
  ...
  HTML::section(2, HTML::strLink(_("Dumps"), '../admin/dump_view_form.php'), array('class' => 'icon icon_dump'));
  ...
  HTML::section(2, HTML::strLink(_("Logs"), '../admin/log_stats.php'), array('class' => 'icon icon_log'));
