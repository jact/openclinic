 ...
 * LogStats_Query.php
 *
 * Contains the class LogStats_Query
 *
 ...
 * @version   CVS: $Id: LogStats_Query.php,v 1.1 2007/01/15 22:36:36 jact Exp $
...
/**
 * LogStats_Query data access component for log stats (access and operations)
 *
 * Methods:
 *  void LogStats_Query(string $table)
...
class LogStats_Query extends Query
{
  /**
   * void LogStats_Query(string $table)
   *
