 ...
 *
 * $Id: test_edit.php,v 1.1 2004/03/24 19:41:00 jact Exp $
 */
 ...
 */
  ...
  echo '<p>' . sprintf(_("Medical test, %s, has been updated."), $test->getPathFilename()) . "</p>\n";
