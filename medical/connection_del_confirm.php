 ...
 *
 * $Id: connection_del_confirm.php,v 1.6 2005/07/20 20:25:24 jact Exp $
 */
...
<form method="post" action="../medical/connection_del.php">
  ...
  <?php showMessage(sprintf(_("Are you sure you want to delete connection, %s, from list?"), $wording)); ?>
