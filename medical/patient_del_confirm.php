 ...
 *
 * $Id: patient_del_confirm.php,v 1.5 2004/10/03 10:26:49 jact Exp $
 */
...
<form method="post" action="../medical/patient_del.php">
  ...
  <?php showMessage(sprintf(_("Are you sure you want to delete patient, %s?"), $patName)); ?>
